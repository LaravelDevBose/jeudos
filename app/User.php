...
class User extends Authenticatable implements MustVerifyEmail
{
     ...
     */
    protected $fillable = [
        'name', 'email', 'password', 'status', 'category_id', 'privacy', 'email_verified_at', 'sub_category_id', 'description', 'profile_video_url', 'profile_image_url', 'tags', 'rate', 'title',
        'slug',
    ];
    ...
    {
        return $this->hasMany(InfluencerSchedule::class, 'user_id', 'id');
    }
