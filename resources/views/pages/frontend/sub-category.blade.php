    ...
    <div class="content-header">
        <div class="d-flex align-items-center">
            <div class="my-auto mx-auto align-self-center align-center text-center">
                ...
                <h5 class="text-light">
                    @foreach($category->subCategory as $serial => $subCategoryy) @if($serial !== 0) / @endif @if($subCategoryy->id == $subCategory->id)<b>{{$subCategoryy->name}}</b> @else {{$subCategoryy->name}} @endif @endforeach
                </h5>
            </div>
        </div>
    </div>
...
@section('content')
    <div class="row">
        <div class="col-md-12 align-items-center">
            <h1 class="float-left text-bold">{{$subCategory->name}}</h1>
        </div>
    </div>
    <div class="row">
