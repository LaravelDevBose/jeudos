            ...
            <div class="box">
                ...
                <div class="box-body">
                    <div class="row justify-content-between pb-25">
                        <div class="col-4">
                            <h2 class="mb-0">{{$influencers->count() > 0 ? round(($influencers->where('status',0)->count()/$influencers->count()) * 100): 0}}%</h2>
                            <div class="progress progress-xs mb-0 mb-10">
                                <div class="progress-bar bg-warning" role="progressbar" style="width: {{$influencers->count() > 0 ? ($influencers->where('status',0)->count()/$influencers->count()) * 100 : 0}}%" aria-valuenow="{{$influencers->count() > 0 ? ($influencers->where('status',0)->count()/$influencers->count()) * 100 : 0}}" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
                        ...
                        <div class="col-4">
                            <h2 class="mb-0">{{$influencers->count() > 0 ? round(($influencers->where('status',1)->count()/$influencers->count()) * 100): 0}}%</h2>
                            <div class="progress progress-xs mb-0 mb-10">
                                <div class="progress-bar bg-success" role="progressbar" style="width: {{$influencers->count() > 0 ? ($influencers->where('status',1)->count()/$influencers->count()) * 100 : 0}}%" aria-valuenow="{{$influencers->count() > 0 ? ($influencers->where('status',1)->count()/$influencers->count()) * 100 : 0}}" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
                            <span class="font-size-16 text-fade">
										Active
									</span>
                        ...
                        <div class="col-4">
                            <h2 class="mb-0">{{$influencers->count() > 0 ? round(($influencers->where('status',2)->count()/$influencers->count()) * 100): 0}}%</h2>
                            <div class="progress progress-xs mb-0 mb-10">
                                <div class="progress-bar bg-danger" role="progressbar" style="width: {{$influencers->count() > 0 ? ($influencers->where('status',2)->count()/$influencers->count()) * 100 : 0}}%" aria-valuenow="{{$influencers->count() > 0 ? ($influencers->where('status',2)->count()/$influencers->count()) * 100 : 0}}" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
                            <span class="font-size-16 text-fade">
										Suspended
									</span>
