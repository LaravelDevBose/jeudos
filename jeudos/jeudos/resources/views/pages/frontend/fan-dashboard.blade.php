...
@section('content')
    ...
    <div class="box box-default">
        <div class="box-header with-border">
            <h4 class="box-title">{{auth()->user()->name}} Dashboard</h4>
        </div>
        <!-- /.box-header -->
        <div class="box-body">
            <!-- Nav tabs -->
            <div class="vtabs customvtab">
                <ul class="nav nav-tabs tabs-vertical" role="tablist">
                    <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#dashboard"
                                    ...
                                    class="ion-home"></i></span> <span class="hidden-xs-down">Dashboard</span>
                        </a></li>
                    <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#wishlist" role="tab"
                                            aria-expanded="false"><span class="hidden-sm-up"><i
                                    class="ion-person"></i></span> <span class="hidden-xs-down">Wishlist</span></a>
                    </li>
                </ul>
                <!-- Tab panes -->
                            ...
                            <div class="col-md-5">
                                <div class="box shadow">
                                    <div class="box-body justify-content-center text-center">
                                        ...
                                        <h4 class="mt-2 mb-0"><a class="hover-primary text-dark"
                                                                 href="#">{{$user->name}}</a></h4>
                                        <p><span class="text-gray">{{$user->email}}</span></p>
                                    </div>
                                </div>
                                <div class="box mt-3 shadow">
                                    <div class="box-body">
                                        <form class="form-horizontal form-element col-12" method="post"
                                              action="{{url('admin/profile/update-personal-info')}}">
                                            @csrf
                                                ...
                                                <form class="form-horizontal form-element col-12" method="post"
                                                    ...
                                                    <div class="form-group row">
                                                        <label for="inputOldPassword"
                                                               class="col-sm-2 control-label">Old Password</label>
                                                    ...
                                                    <div class="form-group row">
                                                        <label for="inputNewPasswordConfirmation"
                                                               class="col-sm-2 control-label">Re-enter New
                                                            Password</label>
